        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <Button 
              ...
              disabled={isLoading}
              title={/iPhone|iPad|iPod|Android/i.test(navigator.userAgent) ? "ההתחברות דרך פייסבוק במובייל עדיין בפיתוח" : "התחבר דרך פייסבוק"}
            >
              <Facebook className="h-5 w-5 mr-2 text-blue-600" />
              Facebook
              {/iPhone|iPad|iPod|Android/i.test(navigator.userAgent) && (
                <span className="text-xs text-gray-500 mr-1">(בפיתוח)</span>
              )}
            </Button>
          </div>
