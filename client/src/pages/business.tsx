      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="md:w-3/5">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md mb-6">
            ...
            <div className="relative h-64 w-full mb-6">
              <img 
                src={business.logoUrl || "https://placehold.co/600x400?text=No+Image"} 
                alt={business.name} 
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-row gap-2 justify-start mt-4">
                ...
                <Button variant="outline" className="bg-blue-50 text-blue-600 border-blue-100" size="sm">
                  שיתוף
                </Button>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
            ...
            <div className="divide-y divide-gray-200 text-right bg-white rounded-lg overflow-hidden border border-gray-200" style={{ direction: 'rtl', textAlign: 'right' }}>
              ...
              <div className="flex flex-row-reverse items-center py-2 px-2 justify-end">
                ...
                <span className="font-medium mr-2">{business.website || business.email}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-2/5">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md mb-6">
            ...
            <div className="divide-y divide-gray-200 text-right bg-white rounded-lg overflow-hidden border border-gray-200" style={{ direction: 'rtl' }}>
